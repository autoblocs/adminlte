...
#' @param allowUI If TRUE (the default), allow dynamic outputs generated by \code{\link[shiny]{uiOutput}} or
#'   \code{\link[shiny]{htmlOutput}}. When a dynamic output is provided, \code{tagAssert} won't try to validate the the
#'   contents.
#' @keywords internal
